...
type TrickEvent int32

const (
	TrickEvent_FOXCAUGHT        TrickEvent = 0
	TrickEvent_DOPPELKOPFSCORED TrickEvent = 1
	TrickEvent_CHARLIESCORED    TrickEvent = 2
)

// Enum value maps for TrickEvent.
var (
	TrickEvent_name = map[int32]string{
		0: "FOXCAUGHT",
		1: "DOPPELKOPFSCORED",
		2: "CHARLIESCORED",
	}
	TrickEvent_value = map[string]int32{
		"FOXCAUGHT":        0,
		"DOPPELKOPFSCORED": 1,
		"CHARLIESCORED":    2,
	}
...
func (x TrickEvent) Enum() *TrickEvent {
	p := new(TrickEvent)
	*p = x
	return p
}

func (x TrickEvent) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TrickEvent) Descriptor() protoreflect.EnumDescriptor {
	return file_api_karlchen_proto_enumTypes[5].Descriptor()
}

func (TrickEvent) Type() protoreflect.EnumType {
	return &file_api_karlchen_proto_enumTypes[5]
}

func (x TrickEvent) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TrickEvent.Descriptor instead.
func (TrickEvent) EnumDescriptor() ([]byte, []int) {
...
type PlayedCard struct {
	...
	TrickEvent  []TrickEvent `protobuf:"varint,5,rep,packed,name=trick_event,json=trickEvent,proto3,enum=api.TrickEvent" json:"trick_event,omitempty"`
}
...
func (x *PlayedCard) GetTrickEvent() []TrickEvent {
	if x != nil {
		return x.TrickEvent
	}
	return nil
...
func (x *Event) GetNewTable() *TableData {
	if x, ok := x.GetEvent().(*Event_NewTable); ok {
		return x.NewTable
	}
	return nil
}
...
type Event_NewTable struct {
	NewTable *TableData `protobuf:"bytes,7,opt,name=new_table,json=newTable,proto3,oneof"`
}
...
func (*Event_NewTable) isEvent_Event() {}
...
func (x *MemberEvent) GetOnline() bool {
	if x != nil {
		return x.Online
	}
	return false
...
func (x *CreateTableRequest) GetPublic() bool {
	if x != nil {
		return x.Public
	}
	return false
...
func (x *ListTablesResult) GetTables() []*TableData {
	if x != nil {
		return x.Tables
	}
	return nil
...
func (x *TableData) GetPublic() bool {
	if x != nil {
		return x.Public
	}
	return false
...
func (x *LoginReply) Reset() {
	*x = LoginReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_karlchen_proto_msgTypes[30]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LoginReply) Descriptor() ([]byte, []int) {
	return file_api_karlchen_proto_rawDescGZIP(), []int{30}
}
...
type JoinTableRequest struct {
	...
	// Types that are assignable to TableDescription:
	//	*JoinTableRequest_TableId
	//	*JoinTableRequest_InviteCode
	TableDescription isJoinTableRequest_TableDescription `protobuf_oneof:"table_description"`
}

func (x *JoinTableRequest) Reset() {
	*x = JoinTableRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_karlchen_proto_msgTypes[31]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*JoinTableRequest) Descriptor() ([]byte, []int) {
	return file_api_karlchen_proto_rawDescGZIP(), []int{31}
}

func (m *JoinTableRequest) GetTableDescription() isJoinTableRequest_TableDescription {
	if m != nil {
...
func (x *JoinTableRequest) GetTableId() string {
	if x, ok := x.GetTableDescription().(*JoinTableRequest_TableId); ok {
		return x.TableId
	}
	return ""
}
...
func (x *JoinTableRequest) GetInviteCode() string {
	if x, ok := x.GetTableDescription().(*JoinTableRequest_InviteCode); ok {
		return x.InviteCode
	}
	return ""
}

type isJoinTableRequest_TableDescription interface {
	isJoinTableRequest_TableDescription()
}

type JoinTableRequest_TableId struct {
	TableId string `protobuf:"bytes,1,opt,name=table_id,json=tableId,proto3,oneof"`
}

type JoinTableRequest_InviteCode struct {
	InviteCode string `protobuf:"bytes,2,opt,name=invite_code,json=inviteCode,proto3,oneof"`
}

func (*JoinTableRequest_TableId) isJoinTableRequest_TableDescription() {}

func (*JoinTableRequest_InviteCode) isJoinTableRequest_TableDescription() {}
...
func (x *StartTableRequest) Reset() {
	*x = StartTableRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_karlchen_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StartTableRequest) Descriptor() ([]byte, []int) {
	return file_api_karlchen_proto_rawDescGZIP(), []int{32}
}
...
func (x *StartNextMatchRequest) Reset() {
	*x = StartNextMatchRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_karlchen_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StartNextMatchRequest) Descriptor() ([]byte, []int) {
	return file_api_karlchen_proto_rawDescGZIP(), []int{33}
}
...
var file_api_karlchen_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x22, 0xd4, 0x01, 0x0a, 0x0a, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x64, 0x43, 0x61, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x49, 0x64, 0x52, 0x69, 0x67, 0x68, 0x74, 0x22, 0xcb, 0x01, 0x0a, 0x09, 0x54, 0x61, 0x62,
	...
	0x62, 0x65, 0x72, 0x73, 0x12, 0x28, 0x0a, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x54, 0x69, 0x6d, 0x65,
	...
	,
	...
	0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x57, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x3e, 0x0a, 0x0d, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79,
	0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x64, 0x22, 0x4f, 0x0a, 0x0a, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_api_karlchen_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
var file_api_karlchen_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_api_karlchen_proto_goTypes = []interface{}{
	...
	(Suit)(0),                     // 3: api.Suit
	(Rank)(0),                     // 4: api.Rank
	(TrickEvent)(0),               // 5: api.TrickEvent
	(Party)(0),                    // 6: api.Party
	(BidType)(0),                  // 7: api.BidType
	(GameType)(0),                 // 8: api.GameType
	(*Card)(nil),                  // 9: api.Card
	(*PlayerValue)(nil),           // 10: api.PlayerValue
	(*PartyValue)(nil),            // 11: api.PartyValue
	(*Declaration)(nil),           // 12: api.Declaration
	(*PlayedCard)(nil),            // 13: api.PlayedCard
	(*Bid)(nil),                   // 14: api.Bid
	(*Event)(nil),                 // 15: api.Event
	(*UserState)(nil),             // 16: api.UserState
	(*MemberEvent)(nil),           // 17: api.MemberEvent
	(*PlayCardRequest)(nil),       // 18: api.PlayCardRequest
	(*PlaceBidRequest)(nil),       // 19: api.PlaceBidRequest
	(*CreateTableRequest)(nil),    // 20: api.CreateTableRequest
	(*DeclareRequest)(nil),        // 21: api.DeclareRequest
	(*ListTablesRequest)(nil),     // 22: api.ListTablesRequest
	(*ListTablesResult)(nil),      // 23: api.ListTablesResult
	(*AuctionState)(nil),          // 24: api.AuctionState
	(*Mode)(nil),                  // 25: api.Mode
	(*Trick)(nil),                 // 26: api.Trick
	(*GameState)(nil),             // 27: api.GameState
	(*Cards)(nil),                 // 28: api.Cards
	(*MatchState)(nil),            // 29: api.MatchState
	(*Players)(nil),               // 30: api.Players
	(*TableData)(nil),             // 31: api.TableData
	(*Timestamp)(nil),             // 32: api.Timestamp
	(*TableState)(nil),            // 33: api.TableState
	(*TableMember)(nil),           // 34: api.TableMember
	(*Empty)(nil),                 // 35: api.Empty
	(*RegisterRequest)(nil),       // 36: api.RegisterRequest
	(*RegisterReply)(nil),         // 37: api.RegisterReply
	(*LoginRequest)(nil),          // 38: api.LoginRequest
	(*LoginReply)(nil),            // 39: api.LoginReply
	(*JoinTableRequest)(nil),      // 40: api.JoinTableRequest
	(*StartTableRequest)(nil),     // 41: api.StartTableRequest
	(*StartNextMatchRequest)(nil), // 42: api.StartNextMatchRequest
}
var file_api_karlchen_proto_depIdxs = []int32{
	3,  // 0: api.Card.suit:type_name -> api.Suit
	4,  // 1: api.Card.rank:type_name -> api.Rank
	6,  // 2: api.PartyValue.party:type_name -> api.Party
	25, // 3: api.Declaration.definedGameMode:type_name -> api.Mode
	9,  // 4: api.PlayedCard.card:type_name -> api.Card
	10, // 5: api.PlayedCard.trick_winner:type_name -> api.PlayerValue
	11, // 6: api.PlayedCard.winner:type_name -> api.PartyValue
	5,  // 7: api.PlayedCard.trick_event:type_name -> api.TrickEvent
	7,  // 8: api.Bid.bid:type_name -> api.BidType
	16, // 9: api.Event.welcome:type_name -> api.UserState
	29, // 10: api.Event.start:type_name -> api.MatchState
	12, // 11: api.Event.declared:type_name -> api.Declaration
	13, // 12: api.Event.played_card:type_name -> api.PlayedCard
	14, // 13: api.Event.placed_bid:type_name -> api.Bid
	17, // 14: api.Event.member:type_name -> api.MemberEvent
	31, // 15: api.Event.new_table:type_name -> api.TableData
	33, // 16: api.UserState.currentTable:type_name -> api.TableState
	0,  // 17: api.MemberEvent.type:type_name -> api.MemberEventType
	9,  // 18: api.PlayCardRequest.card:type_name -> api.Card
	7,  // 19: api.PlaceBidRequest.bid:type_name -> api.BidType
	8,  // 20: api.DeclareRequest.declaration:type_name -> api.GameType
	31, // 21: api.ListTablesResult.tables:type_name -> api.TableData
	12, // 22: api.AuctionState.declarations:type_name -> api.Declaration
	8,  // 23: api.Mode.type:type_name -> api.GameType
	10, // 24: api.Mode.soloist:type_name -> api.PlayerValue
	10, // 25: api.Mode.spouse:type_name -> api.PlayerValue
	9,  // 26: api.Trick.cards:type_name -> api.Card
	10, // 27: api.Trick.user_id_winner:type_name -> api.PlayerValue
	14, // 28: api.GameState.bids:type_name -> api.Bid
	26, // 29: api.GameState.current_trick:type_name -> api.Trick
	26, // 30: api.GameState.previous_trick:type_name -> api.Trick
	25, // 31: api.GameState.mode:type_name -> api.Mode
	9,  // 32: api.Cards.cards:type_name -> api.Card
	2,  // 33: api.MatchState.phase:type_name -> api.MatchPhase
	10, // 34: api.MatchState.turn:type_name -> api.PlayerValue
	30, // 35: api.MatchState.players:type_name -> api.Players
	35, // 36: api.MatchState.spectator:type_name -> api.Empty
	28, // 37: api.MatchState.own_cards:type_name -> api.Cards
	24, // 38: api.MatchState.auction_state:type_name -> api.AuctionState
	27, // 39: api.MatchState.game_state:type_name -> api.GameState
	34, // 40: api.TableData.members:type_name -> api.TableMember
	32, // 41: api.TableData.created:type_name -> api.Timestamp
	1,  // 42: api.TableState.phase:type_name -> api.TablePhase
	29, // 43: api.TableState.current_match:type_name -> api.MatchState
	31, // 44: api.TableState.data:type_name -> api.TableData
	36, // 45: api.Doko.Register:input_type -> api.RegisterRequest
	38, // 46: api.Doko.Login:input_type -> api.LoginRequest
	20, // 47: api.Doko.CreateTable:input_type -> api.CreateTableRequest
	41, // 48: api.Doko.StartTable:input_type -> api.StartTableRequest
	40, // 49: api.Doko.JoinTable:input_type -> api.JoinTableRequest
	18, // 50: api.Doko.PlayCard:input_type -> api.PlayCardRequest
	19, // 51: api.Doko.PlaceBid:input_type -> api.PlaceBidRequest
	21, // 52: api.Doko.Declare:input_type -> api.DeclareRequest
	42, // 53: api.Doko.StartNextMatch:input_type -> api.StartNextMatchRequest
	35, // 54: api.Doko.StartSession:input_type -> api.Empty
	22, // 55: api.Doko.ListTables:input_type -> api.ListTablesRequest
	37, // 56: api.Doko.Register:output_type -> api.RegisterReply
	39, // 57: api.Doko.Login:output_type -> api.LoginReply
	31, // 58: api.Doko.CreateTable:output_type -> api.TableData
	29, // 59: api.Doko.StartTable:output_type -> api.MatchState
	33, // 60: api.Doko.JoinTable:output_type -> api.TableState
	13, // 61: api.Doko.PlayCard:output_type -> api.PlayedCard
	14, // 62: api.Doko.PlaceBid:output_type -> api.Bid
	12, // 63: api.Doko.Declare:output_type -> api.Declaration
	29, // 64: api.Doko.StartNextMatch:output_type -> api.MatchState
	15, // 65: api.Doko.StartSession:output_type -> api.Event
	23, // 66: api.Doko.ListTables:output_type -> api.ListTablesResult
...
func file_api_karlchen_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_karlchen_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_karlchen_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_karlchen_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_karlchen_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_karlchen_proto_msgTypes[20].OneofWrappers = []interface{}{
		(*MatchState_Spectator)(nil),
		(*MatchState_OwnCards)(nil),
		(*MatchState_AuctionState)(nil),
		(*MatchState_GameState)(nil),
	}
	file_api_karlchen_proto_msgTypes[31].OneofWrappers = []interface{}{
		(*JoinTableRequest_TableId)(nil),
		(*JoinTableRequest_InviteCode)(nil),
	}
	type x struct{}
