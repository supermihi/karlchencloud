...
func TestWinnerOfTrick(t *testing.T) {
	...
	// Rule 2.3.4
	AssertCardIsHigher(t, ClubsQ, Hearts10)
	AssertCardIsHigher(t, SpadesQ, ClubsQ)
	AssertCardIsHigher(t, HeartsQ, SpadesQ)
	AssertCardIsHigher(t, DiamondsQ, HeartsQ)
	AssertCardIsHigher(t, ClubsJ, DiamondsQ)
	AssertCardIsHigher(t, SpadesJ, ClubsJ)
	AssertCardIsHigher(t, HeartsJ, SpadesJ)
	AssertCardIsHigher(t, DiamondsJ, HeartsJ)
	AssertCardIsHigher(t, DiamondsA, DiamondsJ)
